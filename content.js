const siteContent = {
  vi: {
    ...
    researchDetails: {
      'rare-earths': { title: 'Chiết tách, phân chia và ứng dụng đất hiếm', lead: 'Khai thác giá trị của khoáng đất hiếm Việt Nam bằng quy trình hóa học và vật liệu chức năng.', studies: ['Chế biến khoáng vật xenotime và quặng monazit.', 'Sản xuất phức đất hiếm cho phân bón lá bổ sung vi lượng nano.', 'Vật liệu La2O3/CeO2 cho hấp phụ arsenite, phosphate và xúc tác môi trường.', 'Vật liệu Ce-doped ZnO, C/Ce-co-doped ZnO/graphene cho quang xúc tác.'], outputs: ['VN Patent No. 44433 (2025): Phương pháp chế biến khoáng vật xenotime.', 'VN Patent No. 52319 (2025): Quy trình sản xuất phân bón lá trên cơ sở phức chất đất hiếm bổ sung vi lượng nano.', 'VN Patent No. 41857 (2024): Quy trình chế biến quặng monazit.', 'Luu et al. (2026), Inorganic Chemistry Communications, DOI: 10.1016/j.inoche.2026.116329.', 'Nguyen et al. (2021), La2O3 nanoparticles for arsenite and phosphate removal.'] },
      'hydrometallurgy': { title: 'Thủy luyện và thu hồi kim loại quý hiếm', lead: 'Tối ưu hóa các bước hòa tách, phân chia, kết tủa và thu hồi kim loại từ quặng và nguồn thứ cấp.', studies: ['Thu hồi xenotime từ quặng giàu sắt-silicate.', 'Chế biến monazit theo hướng tách đất hiếm và giảm tạp.', 'Thu hồi antimony từ nguồn chứa antimony.', 'Kết nối thủy luyện với đánh giá môi trường và tận dụng phụ phẩm.'], outputs: ['VN Patent No. 23004 (2019): Quy trình thu hồi antimony từ các nguồn chứa antimony.', 'A beneficiation study to recover xenotime minerals from rich-iron-silicate ores, DOI: 10.1002/cjce.25038.', 'VN Patent No. 44433 (2025) và VN Patent No. 41857 (2024).'] },
    ...
    peopleList: [
      ...
      { section: 'Researchers', members: [
        ...
        { name: 'TS. Nguyễn Trung Kiên', role: 'Nhân viên biên chế', focus: 'Phòng 408, nhà B2. Hướng nghiên cứu sẽ được cập nhật.', email: 'ntkien@ims.vast.ac.vn', photo: '../assets/nguyen-trung-kien.jpg', links: [ { label: 'ORCID', url: 'https://orcid.org/0000-0001-5213-3882' }, { label: 'ResearchGate', url: 'https://www.researchgate.net/profile/Kien-Nguyen-120' } ] },
    ...
    publicationList: [
      ...
      { type: 'patent', year: '2019', title: 'Quy trình thu hồi antimony từ các nguồn chứa antimony', meta: 'Bằng độc quyền sáng chế số 23004.' }
    ],
    activitiesList: [
  ...
  en: {
    ...
    common: { labName: 'Inorganic Materials Laboratory', labShort: 'IML', affiliation: 'Institute of Materials Science', ctaResearch: 'Explore research', ctaContact: 'Start collaboration', contactUs: 'Contact us', sourceNote: 'Base content references public information from the Inorganic Materials Laboratory, Institute of Materials Science.' },
    ...
    peopleList: [
      ...
      { section: 'Researchers', members: [
        ...
        { name: 'Dr. Nguyen Trung Kien', role: 'Research staff', focus: 'Office 408, Building B2. Research details will be updated.', email: 'ntkien@ims.vast.ac.vn', photo: '../assets/nguyen-trung-kien.jpg', links: [ { label: 'ORCID', url: 'https://orcid.org/0000-0001-5213-3882' }, { label: 'ResearchGate', url: 'https://www.researchgate.net/profile/Kien-Nguyen-120' } ] },
